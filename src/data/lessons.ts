...
export const lessonsData: Lesson[] = [
  ...
  ...Array.from({ length: 47 }, (_, i): Lesson => {
    ...
    const mockTitles: Record<number, {jp: string, vn: string}> = {
      4: { jp: "時間、日付と日常生活", vn: "Giờ giấc, Ngày tháng & Hoạt động hàng ngày" },
      5: { jp: "移動、交通手段と同行者", vn: "Sự di chuyển, Phương tiện & Bạn đồng hành" },
      6: { jp: "動詞、行動と目的語", vn: "Động từ, Hành động & Tân ngữ" },
      7: { jp: "道具、手段、授受", vn: "Công cụ, Phương tiện, Cho & Nhận" },
      8: { jp: "形容詞（性質と状態）", vn: "Tính từ (Tính chất & Trạng thái)" },
      9: { jp: "嗜好、能力と所有", vn: "Sở thích, Khả năng & Sở hữu" },
      10: { jp: "人、動物、物の存在", vn: "Sự tồn tại của Người, Động vật & Đồ vật" },
      11: { jp: "助数詞、数量と期間", vn: "Lượng từ, Số đếm & Thời gian học" },
      12: { jp: "形容詞と名詞の過去形", vn: "Quá khứ của Tính từ & Danh từ" },
      13: { jp: "願望、意図と目的", vn: "Mong muốn, Ý định & Mục đích" },
      14: { jp: "依頼とて形の導入", vn: "Yêu cầu & Giới thiệu thể Te" },
      15: { jp: "許可、禁止と現在の状態", vn: "Cho phép, Cấm đoán & Trạng thái hiện tại" },
      16: { jp: "文の結合と順序", vn: "Kết hợp câu & Trình tự hành động" },
      17: { jp: "否定の依頼とない形", vn: "Yêu cầu phủ định & Thể Nai" },
      18: { jp: "能力、趣味と辞書形", vn: "Khả năng, Sở thích & Thể từ điển" },
      19: { jp: "経験とた形", vn: "Kinh nghiệm & Thể Ta" },
      20: { jp: "丁寧体と普通体", vn: "Thể lịch sự & Thể thông thường" },
      21: { jp: "意見、思考と引用", vn: "Ý kiến, Suy nghĩ & Trích dẫn" },
      22: { jp: "名詞修飾節", vn: "Mệnh đề bổ nghĩa danh từ" },
      23: { jp: "条件、道筋と時の節", vn: "Điều kiện, Đường đi & Mệnh đề thời gian" },
      24: { jp: "授受動詞（恩恵）", vn: "Động từ cho nhận hành động (Trợ giúp)" },
      25: { jp: "条件節（たら形）", vn: "Mệnh đề điều kiện (Thể Tara)" },
      // N4 Lessons 26 - 50
      26: { jp: "理由の説明と助言の要求", vn: "Giải thích lý do & Xin lời khuyên" },
      27: { jp: "能力と可能動詞", vn: "Khả năng & Động từ thể khả năng" },
      28: { jp: "同時進行と習慣", vn: "Hành động song song & Thói quen" },
      29: { jp: "自動詞と状態描写", vn: "Tự động từ & Mô tả trạng thái" },
      30: { jp: "他動詞と準備行動", vn: "Tha động từ & Hành động chuẩn bị sẵn" },
      31: { jp: "意向形と未来の意図", vn: "Thể ý chí & Ý định tương lai" },
      32: { jp: "提案、推量と忠告", vn: "Gợi ý, Dự đoán & Khuyên bảo" },
      33: { jp: "命令形と禁止形", vn: "Thể mệnh lệnh & Thể cấm đoán" },
      34: { jp: "指示と順序に従う", vn: "Làm theo chỉ dẫn & Trình tự" },
      35: { jp: "条件形（ば形）", vn: "Thể điều kiện (Thể Ba)" },
      36: { jp: "目的、目標と習慣の変化", vn: "Mục tiêu, Mục đích & Thay đổi thói quen" },
      37: { jp: "受身動詞", vn: "Động từ thể bị động" },
      38: { jp: "名詞化節（の・こと）", vn: "Danh từ hóa mệnh đề (No & Koto)" },
      39: { jp: "原因、理由と感情の表現", vn: "Biểu đạt nguyên nhân, Lý do & Cảm xúc" },
      40: { jp: "疑問詞節と不確実性", vn: "Câu hỏi lồng & Sự không chắc chắn" },
      41: { jp: "目上・目下への授受", vn: "Cho và nhận kính ngữ/khiêm nhường ngữ" },
      42: { jp: "目的、用途と準備", vn: "Mục đích sử dụng & Chuẩn bị" },
      43: { jp: "外見と直前の行動", vn: "Vẻ bề ngoài & Hoạt động sắp diễn ra" },
      44: { jp: "超過と難易度", vn: "Sự quá mức & Dễ/Khó làm gì" },
      45: { jp: "仮定状況（場合・のに）", vn: "Tình huống giả định (Trường hợp)" },
      46: { jp: "時間の局面と完了状態", vn: "Các khía cạnh thời gian & Trạng thái hoàn thành" },
      47: { jp: "伝聞、報告と兆候", vn: "Tin đồn, Báo cáo & Dấu hiệu" },
      48: { jp: "使役動詞", vn: "Động từ thể sai khiến" },
      49: { jp: "尊敬語", vn: "Kính ngữ (Sonkeigo)" },
      50: { jp: "謙譲語", vn: "Khiêm nhường ngữ (Kenjougo)" }
    };

    const titleJp = mockTitles[lessonNum]?.jp || `内容`;
    const titleVn = mockTitles[lessonNum]?.vn || `Bài ${lessonNum}: Nội dung bài học`;

    return {
      id: lessonNum,
      title: `第${lessonNum}課: ${titleJp} (${levelStr})`,
      titleVn: titleVn,
      vocabulary: [
        { jp: "本", kana: "ほん", romaji: "hon", vn: "Sách" },
