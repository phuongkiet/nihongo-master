...
export const LessonDetail: React.FC<LessonDetailProps> = ({
  ...
  const handleCompletePractice = (_score: number) => {
    if (!isCompleted) {
  ...
  return (
    <div className="max-w-[850px] mx-auto px-4 pb-32 animate-fade-in relative">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-3.5 flex-wrap">
            <button 
              ...
              className={`px-5 py-2.5 rounded-xl text-sm font-bold shadow-soft transition-all active:scale-95 flex items-center gap-2 ${
                activeTab === 'vocabulary'
                  ? 'bg-scholastic-navy text-white hover:bg-indigo-950 shadow-md'
                  : 'border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-scholastic-navy hover:text-scholastic-navy'
              }`}
            >
      ...
      {activeTab === 'grammar' && (
        <section id="grammar" className="mb-16 scroll-mt-6 animate-scale-in">
          <div className="flex items-center gap-3 mb-6">
